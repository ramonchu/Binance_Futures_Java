    ...
    WebsocketRequest<UserDataUpdateEvent> subscribeUserDataEvent(String listenKey,
        ...
        request.jsonParser = (jsonWrapper) -> {
            ...
            if (jsonWrapper.containKey("T"))
                result.setTransactionTime(jsonWrapper.getLong("T"));
            result.setEventReasonType(jsonWrapper.getStringOrDefault("m",null));
            ...
            if(jsonWrapper.getString("e").equals("ACCOUNT_UPDATE")) {
                ...
                orderUpdate.setActivationPrice(jsondata.getBigDecimalOrDefault("AP",null));
                orderUpdate.setCallbackRate(jsondata.getBigDecimalOrDefault("cr",null));
